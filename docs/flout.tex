...
The script requires FLUKA package version $\geq$ 3.0 distributed by CERN and bash shell version $\geq$ 4.0.
...
process all binary files in auto mode and copy them into subdirectory \texttt{result}.
