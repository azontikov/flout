...
By default FLOUT searches for FLUKA readout programs inside CERN FLUKA distribution
so make sure its \texttt{/bin} folder is available on your \texttt{\$PATH}.
Supplying the \texttt{--old} parameter allows to search for readout codes inside INFN FLUKA distribution
...
-- add \texttt{-{}-old} parameter to support INFN FLUKA distribution, update docs\newline
